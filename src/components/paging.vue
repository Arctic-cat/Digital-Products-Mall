...
.paging > .paging-item:first-child {
  margin-left: 0;
}
...
.paging > .paging-item.paging-item--disabled, .paging > .paging-item.paging-item--more {
  background-color: #fff;
  color: #505050;
}
.paging > .paging-item.paging-item--disabled {
  opacity: .75;
}
.paging > .paging-item.paging-item--more, .paging > .paging-item.paging-item--current {
  cursor: default;
}
